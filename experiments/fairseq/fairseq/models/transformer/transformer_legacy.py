    ...
    def build_decoder(cls, args, tgt_dict, embed_tokens):
        if args.decoder_type == "roformer":
            return RotaryDecoderOnly(
                args, tgt_dict, embed_tokens, getattr(args, "no_cross_attention", False)
            )
...
@register_model_architecture("transformer", "transformer_decoder_only_MTLA_cross_xm")
def transformer_decoder_only_MTLA_cross_xm(args):
...
@register_model_architecture("transformer", "transformer_decoder_only_MLA_cross_xm")
def transformer_decoder_only_MLA_cross_xm(args):
...
@register_model_architecture(
    "transformer", "transformer_decoder_only_roformer_cross_xm"
)
def transformer_decoder_only_roformer_cross_xm(args):
